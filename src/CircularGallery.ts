...
export class CircularGalleryApp {
  ...
  createMedias(
    ...
    const defaultItems: MediaItem[] = [
      { image: '/1.jpeg', text: 'Photo 1' },
      { image: '/2.jpeg', text: 'Photo 2' },
      { image: '/3.jpeg', text: 'Photo 3' },
      { image: '/4.jpeg', text: 'Photo 4' },
      { image: '/5.jpeg', text: 'Photo 5' },
      { image: '/6.jpeg', text: 'Photo 6' },
      { image: '/7.jpeg', text: 'Photo 7' },
      { image: '/8.jpeg', text: 'Photo 8' },
      { image: '/9.jpeg', text: 'Photo 9' },
      { image: '/10.jpeg', text: 'Photo 10' },
    ];
    ...
    this.medias = this.mediasImages.map((data, index) => {
      return new Media({
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        geometry: this.planeGeometry as any,
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        gl: this.gl as any,
        image: data.image,
        index,
  ...
  onWheel(e: WheelEvent) {
    // Only handle wheel events when the cursor is over this container
  ...
  pauseAutoScroll() {
    ...
    if (this.autoScrollResumeTimer) clearTimeout(this.autoScrollResumeTimer);
  ...
  update() {
    // Auto-scroll at low speed when user isn't interacting
    if (!this.autoScrollPaused && !this.isDown) {
  ...
  addEventListeners() {
    ...
    this.container.addEventListener('touchmove', this.boundOnTouchMove as EventListener, { passive: true });
